"""Kafka Producer - Generate Test E-commerce Data (Docker Version)"""
import json, time, random
from datetime import datetime
from kafka import KafkaProducer

# Use kafka:29092 for Docker internal network
...
if __name__ == "__main__":
    print("Kafka Event Producer (Docker)")
    print("=" * 50)
    producer = create_producer()
    print(f"✓ Connected to Kafka: {KAFKA_BROKER}")
    send_events(producer, 100)
    producer.close()
